...
Up2 Map Places allows you to display Google Maps in your content easily.
...
* Gmap3 jQuery plugin: http://gmap3.net/
* php-csv-parser: https://code.google.com/p/php-csv-parser/
...
1. Map Place Options
2. Map Places Shortcode Generator
3. Submit Map Place Form on front-end
4. Map Direction Shortcode generator
